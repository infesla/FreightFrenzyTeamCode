...
@Autonomous(name="AutoOldBLue", group="Auto")
@Disabled
public class AutoOldBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        GoTo(20, 43, -39, 0.5, 3, baza, "stop"); // порт
        ...
        GoTo(2, -7, -90, 0.6, 1.8, 1, "continue"); // склад
        GoTo(-65, -7, -90, 0.55, 2.75, 1, "element"); // элемент
        GoTo(-65, -7, -90, 0.4, 0.5, 1, "stop"); // выравнивание
        obnul(0.04, -31, -6); // обнуление координат
        GoTo(2, -7, -90, 0.5, 2.5, 1, "continue"); // склад

        
        GoTo(20, 43, -39, 0.5, 3.25, 3, "stop"); // порт
        ...
        GoTo(2, -7, -90, 0.6, 1.8, 1, "continue"); // склад
        GoTo(-65, -7, -90, 0.55, 2.5, 1, "element"); // элемент
