...
//@Disabled
public class DetectorRed extends OpenCvPipeline {
    Telemetry telemetry;
    ...
    public DetectorRed (Telemetry t) { telemetry = t; }
    ...
    public Mat processFrame(Mat input) {
        ...
        double centerValue = Core.sumElems(mrv1).val[0] / rv1.area() / 255;
        double rightValue = Core.sumElems(mrv2).val[0] / rv2.area() / 255;
